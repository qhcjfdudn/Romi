...
import HomePage from './robot/HomePage'
import AuthCodePage from './robot/AuthCodePage'
import GuidePage from './robot/GuidePage'
import ListOnFloorPage from './robot/ListOnFloorPage'
import DestinationPage from './robot/DestinationPage'
import ServicePage from './robot/ServicePage'
import WelcomePage from './robot/WelcomePage'
